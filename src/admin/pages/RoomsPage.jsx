    ...
    <div className="p-4 sm:p-6 md:p-8 lg:p-10 min-h-screen">
      <div className="bg-white rounded-lg shadow-xl p-4 sm:p-6 md:p-8">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 border-b pb-6">
          <h2 className="text-2xl sm:text-3xl font-extrabold text-gray-900 mb-4 md:mb-0">Room Management</h2>
          <button
            onClick={() => {
        ...
        {loading && (
          <div className="flex flex-col items-center justify-center py-12 text-gray-500">
            ...
            <p className="mt-2 text-base sm:text-lg font-medium">Loading rooms...</p>
          </div>
        )}
        {error && (
          ...
          <div className="overflow-x-auto shadow-md rounded-lg border border-gray-200">
            <table className="min-w-full divide-y divide-gray-200 text-left">
              <thead className="bg-gray-50">
                <tr>
                  <th className="px-4 py-3 sm:px-6 text-xs font-semibold text-gray-500 uppercase tracking-wider">Type</th>
                  <th className="px-4 py-3 sm:px-6 text-xs font-semibold text-gray-500 uppercase tracking-wider">Price</th>
                  <th className="px-4 py-3 sm:px-6 text-xs font-semibold text-gray-500 uppercase tracking-wider">Quantity</th>
                ...
                {rooms.length > 0 ? (
                  rooms.map((room) => (
                    <tr key={room.id} className="hover:bg-gray-50 transition-colors duration-150">
                      ...
                      <td className="px-4 py-4 sm:px-6 whitespace-nowrap">
                        <div className="text-sm text-gray-600">{room.quantity}</div>
                      </td>
