...
import { CalendarIcon, CheckIcon, XMarkIcon, ClockIcon, PencilIcon } from '@heroicons/react/24/outline';
import { toast } from 'react-hot-toast';

const MyBookingsPage = () => {
  const navigate = useNavigate();
  const { myBookings, fetchMyBookings, updateBookingStatus, loading, error } = useBookingStore();
                  ...
                  <div className="px-4 py-5 sm:px-6">
                    ...
                    <div className="mt-4 flex justify-end space-x-3">
                      ...
                      >
                        ...
                        {showReviewForm === booking.id ? 'Cancel Review' : 'Give Review'}
                      </button>
                    </div>

                    {showReviewForm === booking.id && (
                      <div className="mt-4 p-4 bg-gray-50 rounded-lg">
                        <h4 className="text-sm font-medium text-gray-700 mb-3">Share your experience</h4>
                        ...
                        <button
                         onClick={() => handleSubmitReview(booking.id, booking.roomTypeId,)}
